  ...
  return (
    <div className="flex flex-col items-start space-y-4">
      <div className="text-left">
        ...
        <p className="text-sm text-slate-600 font-medium">November 20, 2025</p>
      </div>
      <div className="flex gap-4">
        {timeUnits.map((unit, index) => (
          <div key={unit.label} className="flex flex-col items-center">
            <div
              className="rounded-xl px-4 py-3 min-w-[70px] text-center shadow-lg border-2 relative overflow-hidden"
              style={{
            ...
            <div className="text-xs text-slate-700 mt-2 font-bold uppercase tracking-wide">
              {unit.label}
            </div>
          </div>
        ))}
...
export default function JENLandingMockup() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-slate-50 text-slate-800">
      <header className="sticky top-0 z-50 backdrop-blur bg-white/70 border-b border-black/5 shadow-lg">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: brand.primary }}
            >
              <span className="text-base font-extrabold tracking-tight text-white/90">
                J
              </span>
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="ml-1 hidden md:inline">Get the App</span>
            </div>
          </div>
        </nav>
      </header>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-4 pb-16 pt-12 md:grid-cols-2 md:gap-12 md:pt-16">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSffL0izXc5xVA8CnpEbsNb7zEWcAjZ_UNKvqLMmoWPGeGriHQ/viewform?embedded=true"
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-2xl px-5 py-3 text-sm font-semibold text-white shadow-sm hover:shadow-md transition-all"
                style={{ background: brand.primary }}
              >
                Join Beta Testers
              </a>
          ...
          <div className="mb-8 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-slate-600">
                ...
                Final design may differ slightly from the mocked up screens.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-3">
            ...
            <div className="flex justify-end">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-white ring-1 ring-white/20 hover:bg-white/10 transition-colors inline-block"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
